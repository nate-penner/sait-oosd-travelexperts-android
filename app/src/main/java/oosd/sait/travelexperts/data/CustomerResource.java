...
/**
 * A data source for obtaining customer information from an API, which implements {@link DataResource}
 * (see for documentation of interface methods)
 * @see Customer for information about the type of data used by this resource
